...
#Load data
summary=read.delim(infile)
names(summary)[names(summary)=="Taxa.Name"]="taxon"
names(summary)[names(summary)=="Proportion.Missing"]="missing"
names(summary)[names(summary)=="Proportion.Heterozygous"]="het"
